                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" 
                                                  ...
                                                  class="form-control" 
                                                  rows="4"
                                                  placeholder="Detailed product description, specifications, features..."><?= old('description') ?></textarea>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">Product supplier (optional)</div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="small mb-0">
                            ...
                            <li>Include detailed descriptions with specifications and compatibility information</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="small mb-0">
