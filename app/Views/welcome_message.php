        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="card-title">Vehicle Compatibility</h5>
                    <p class="card-text text-muted">Maintain accurate vehicle compatibility data to help customers find the right parts for their specific car models.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <p class="card-text text-muted">Build and manage relationships with suppliers, track orders, and maintain competitive pricing strategies.</p>
                </div>
            </div>
        </div>
